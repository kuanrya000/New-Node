...
class Sound(object):
    ...
    def volumechange(self, num):
        self.volume = 4 + (0.08*num)
        return

    def pitchchange(self, num):
        self.pitch_shift = (num/25)
        return

    def speedchange(self, num):
        self.stretch_factor = 1.0 + (num/51)
        return
    ...
    @classmethod
    def from_file(cls, filename, sr=44100):
